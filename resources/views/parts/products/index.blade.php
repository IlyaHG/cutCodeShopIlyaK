...
<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="product.html" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
        <img src="{{ asset('/images/products/'  . $product->id . '.jpg' ) }}" class="object-cover w-full h-full" alt="{{ $product->title }}">
    </a>
    <div class="grow flex flex-col py-8 px-6">
        <h3 class="text-sm lg:text-md font-black"><a href="product.html" class="inline-block text-white hover:text-pink">
                {{ $product->title }}
                {{-- SteelSeries Aerox 3 Snow --}}
            </a></h3>
